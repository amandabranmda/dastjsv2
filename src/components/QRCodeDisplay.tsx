...
export function QRCodeDisplay({ base64Image, isLoading, instanceName }: QRCodeDisplayProps) {
  ...
  return (
    <Card className="glass-card p-4 sm:p-6 flex flex-col items-center gap-4 w-[95%] max-w-[350px] mx-auto">
      {instanceName && (
      ...
      <div className="w-full aspect-square max-w-[250px] sm:max-w-[280px] flex items-center justify-center bg-white p-2 sm:p-4 rounded-lg">
        <img
          src={base64Image}
          alt="QR Code"
